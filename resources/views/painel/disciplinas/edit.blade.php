    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-primary">
                ...
                {!! Form::open(['role' => 'form', 'class' => 'form-horizontal', 'method' => 'PUT', 'route' => ['disciplinas.update', $disciplina->id], 'files' => true]) !!}
                ...
                <div class="box-body">
                        ...
                        <div class="col-sm-6">
                            <select name="curso_id" id="curso_id" class="form-control select">
                                ...
                                @foreach($cursos as $curso)
                                    @if($disciplina->curso_id == $curso->id )
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            {!! Form::text('nome', $disciplina->nome, ['class' => 'form-control', 'placeholder' => 'Nome da disciplina']) !!}
                            {!! $errors->first('nome') !!}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            {!! Form::textarea('descricao', $disciplina->descricao, ['class' => 'form-control ckeditor', 'placeholder' => 'Nome da disciplina']) !!}
